    ...
    <Container vertical>
      ...
      <Container>
        ...
        >
          ...
          <SubTitle text="Markazning muvaffaqiyati kaliti 🔑" width={350} margin='0 0 2.2rem 0' />
          <SubTitle text='👋 davomat muammosi bilan hayrlashing!' isMuted={true} fSize={18} margin='0 0 1rem 0' />
